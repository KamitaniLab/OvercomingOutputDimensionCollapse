...
def parse_arguments():
    ...
    parser.add_argument('--decoded_feature_name', type=str, default='decoded-feature-ridge-alpha1000.0',
                       help='Name of decoded feature')
    parser.add_argument('--subject', type=str, default='sub-01',
                       help='Subject to use for brain data')
    parser.add_argument('--roi', type=str, default='VC',
                       help='ROI to use for brain data')
...
def get_configuration(args) -> Dict[str, Any]:
    ...
    return {
        ...
        "roi": args.roi,
        "paths": {
            "output_root": Path(args.output_dir) / args.test_dataset_name / args.decoded_feature_name / args.setting,
            "decoded_feature_root": Path(args.feature_dir) / args.test_dataset_name / args.decoded_feature_name / args.setting,
        },
        "optimization": {
